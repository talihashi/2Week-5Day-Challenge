...
function canWeDeliver (zipcode) {
    if (zipcode === deliveryAreaZipCodes[0]) {
        console.log("You're in our delivery zone!");
    } else if (zipcode === deliveryAreaZipCodes[1]) {
        console.log("You're in our delivery zone!");
    } else if (zipcode === deliveryAreaZipCodes[2]) {
        console.log("You're in our delivery zone!");
    } else if (zipcode === deliveryAreaZipCodes[3]) {
        console.log("You're in our delivery zone!");
    } else if (zipcode === deliveryAreaZipCodes[4]) {
        console.log("You're in our delivery zone!");
    } else {
        console.log("Sorry, we can't deliver to that address.");
    }
